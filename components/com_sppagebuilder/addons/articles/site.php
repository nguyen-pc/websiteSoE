			...
			foreach ($items as $key => $item)
			{
				...
				if ($show_author || $show_category || $show_date || $show_tags)
				{
					...
					if ($show_date)
					{
						...
						$output .= '<time datetime="'. $date_format . '" class="sppb-meta-date">' . $date_text . $date . '</time>';
					}
					...
					if ($show_last_modified_date) 
					{
						...
						$output .= '<time datetime="'. $modify_date_format . '" class="sppb-meta-date">' . $modify_text . $modify_date . '</time>';
					}

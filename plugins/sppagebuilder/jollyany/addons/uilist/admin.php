...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'repeatable',
		'addon_name' => 'uilist',
		'title' => JText::_('UI List'),
		'desc' => JText::_('Easily create nice looking lists, which come in different styles.'),
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uilist/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'sp_uilist_item' => array(
					...
					'attr' => array(
						...
						'icon_item_color' => array(
							...
							'desc' => JText::_('Select the item icon color.'),
							'values' => array(
								'' => JText::_('None'),
								'muted' => JText::_('Muted'),
				...
				'list_style' => array(
					...
					'values' => array(
						'' => JText::_('None'),
						'uk-list-divider' => JText::_('Divider'),
						'uk-list-striped' => JText::_('Striped'),
					),
					'std' => '',
				),
				'list_size' => array(
					'type' => 'select',
					'title' => JText::_('Size'),
					'desc' => JText::_('Define the padding between items.'),
					'values' => array(
						'' => JText::_('Default'),
						'large' => JText::_('Large'),
				...
				'column' => array(
					...
					'desc' => JText::_('Set the number of list columns.'),
					'values' => array(
						'' => JText::_('None'),
						'1-2' => JText::_('Halves'),
						'1-3' => JText::_('Thirds'),
				...
				'column_divider' => array(
					...
					'desc' => JText::_('Show a divider between list columns.'),
					'values' => array(
						1 => JText::_('JYES'),
						0 => JText::_('JNO'),
					),
				...
				'column_breakpoint' => array(
					...
					'desc' => JText::_('Set the device width from which the list columns should apply.'),
					'values' => array(
						'' => JText::_('Always'),
				...
				'list_element' => array(
					'type' => 'select',
					'title' => JText::_('HTML Element'),
					'desc' => JText::_('Choose between an ordered and unordered list to fit your semantic structure.'),
					'values' => array(
						'ul' => JText::_('ul'),
						'ol' => JText::_('ol'),
					),
				...
				'image_positions' => array(
					...
					'desc' => JText::_('Align the image to the left, right.'),
					'values' => array(
						'' => JText::_('Left'),
						'right' => JText::_('Right'),
					),
				...
				'icon_color' => array(
					...
					'desc' => JText::_('Select the predefined icon text color.'),
					'values' => array(
						'' => JText::_('None'),
						'muted' => JText::_('Muted'),
						'emphasis' => JText::_('Emphasis'),
				...
				'link_style' => array(
					'type' => 'select',
					'title' => JText::_('Style'),
					'desc' => JText::_('This option doesn\'t apply unless a URL has been added to the item.'),
					'values' => array(
						'' => JText::_('None'),
						'muted' => JText::_('Muted'),
						'reset' => JText::_('Reset'),

...
SpAddonsConfig::addonConfig(
    array(
      'type' => 'content',
      'addon_name' => 'uitoggle',
      'title' => JText::_('UI Toggle'),
      'desc' => JText::_('Hide, switch or change the appearance of different contents through a toggle.'),
      'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uitoggle/assets/images/icon.png',
      'category' => 'Jollyany',
      'attr' => array(
          'general' => array(
            'admin_label' => array(
            ...
            'toggle_type' => array(
                'type' => 'select',
                'title' => JText::_('Toogle Content Type'),
                'desc' => JText::_('Select Toogle type, change the appearance of different contents through a toggle.'),
                'values' => array(
                    '' => JText::_('Switcher'),
                    'toogle_text' => JText::_('Button'),
                ),
                'std' => '',
            ),
            'before_toggle' => array(
                'type' => 'text',
                'title' => JText::_('Text before'),
                'std' => 'Annual',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'after_toggle' => array(
                'type' => 'text',
                'title' => JText::_('Text after'),
                'std' => 'Lifetime',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'toggle_align' => array(
                ...
                'desc' => JText::_('These classes define the alignment of flex items.'),
                'values' => array(
            ...
            'toggle_animation' => array(
                'type' => 'select',
                'title' => JText::_('Toggle Animation'),
                'desc' => JText::_('Add animations to items when toggling between them.'),
                'values' => array(
                    '' => JText::_('Inherit'),
                    'fade' => JText::_('Fade'),
            ...
            'toggle_color' => array(
                'type' => 'color',
                'title' => JText::_('Onclick Background'),
                'desc' => JText::_('Background color for toggle color'),
                'std' => '#1e87f0',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'visible_text' => array(
                'type' => 'editor',
                'title' => JText::_('Visible Content'),
                'desc' => JText::_('Content visible before clicking toggle button'),
                'std' => '',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'hidden_text' => array(
                'type' => 'editor',
                'title' => JText::_('Hidden Content'),
                'desc' => JText::_('Content display after clicking on toggle button'),
                'std' => '',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'button_title' => array(
            ...
            'button_hidden_text' => array(
                'type' => 'textarea',
                'title' => JText::_('Content on click'),
                'desc' => JText::_('Content display after clicking on text button'),
                'std' => '',
                'depends' => array(array('toggle_type', '!=', '')),
            ),

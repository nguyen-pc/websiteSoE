...
class SppagebuilderAddonUiLightGallery extends SppagebuilderAddons {
	...
	public function scripts() {
		return array(
			JURI::base( true ) . '/plugins/sppagebuilder/jollyany/addons/uilightgallery/assets/js/lightgallery.min.js',
		);
	}
	public function stylesheets() {
		return array(
			JURI::base( true ) . '/plugins/sppagebuilder/jollyany/addons/uilightgallery/assets/css/lightgallery.min.css',
			JURI::base( true ) . '/plugins/sppagebuilder/jollyany/addons/uilightgallery/assets/css/lg-transitions.min.css',
			JURI::base( true ) . '/plugins/sppagebuilder/jollyany/addons/uilightgallery/assets/css/lg-fb-comment-box.min.css',
		);
	}
}

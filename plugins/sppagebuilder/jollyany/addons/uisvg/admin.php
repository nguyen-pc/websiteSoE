...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uisvg',
		'title' => JText::_('UI Svg'),
		'desc' => JText::_('Inject inline SVG images into the page markup and style them with CSS.'),
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uisvg/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'preserve' => array(
					'type' => 'checkbox',
					'title' => JText::_('Preserve Color'),
					'desc' => JText::_('SVGs will adapt the current color for their stroke and fill color. To prevent this behavior, you can use this option to add css class to the SVG itself or to elements inside the SVG.'),
					'std' => 0,
					'depends' => array(
						array('image', '!=', ''),
					),
				...
				'use_link' => array(
					'type' => 'checkbox',
					'title' => JText::_('Use Link'),
					'desc' => JText::_('Check this option to insert the link for svg image.'),
					'std' => 0
				),

...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uivideo',
		'title' => JText::_('UI Video'),
		'desc' => JText::_('Start playing videos as they are shown or enter the viewport.'),
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uivideo/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'title_heading_selector' => array(
					...
					'desc' => JText::_('Choose the title html element from the list to fit your semantic structure.'),
					'values' => array(
						'h1' => JText::_('h1'),
						'h2' => JText::_('h2'),
						'h3' => JText::_('h3'),
				...
				'video_source' => array(
					'type' => 'select',
					'title' => JText::_('Source'),
					'values' => array(
						'html5' => JText::_('Html5 Video'),
						'youtube-vimeo' => JText::_('Youtube/Vimeo'),
						'modal' => JText::_('Modal'),
					),
					'std' => 'youtube-vimeo',
				...
				'url' => array(
					'type' => 'text',
					'title' => JText::_('YouTube or Vimeo Video URL'),
					'desc' => JText::_('Select a video file or enter a link from <a href="https://www.youtube.com" target="_blank">YouTube</a> or <a href="https://vimeo.com" target="_blank">Vimeo</a>'),
				...
				'alt_text' => array(
					'type' => 'text',
					'title' => JText::_('Alt Text'),
					'desc' => JText::_('Insert Alt text, which is an important for SEO purposes and part of making a site accessible.'),
					'std' => 'Image',
					'depends' => array(array('video_source', '=', 'modal')),
				),
				'width' => array(
					'type' => 'slider',
					'title' => JText::_('Video Modal Width'),
					'std' => 960,
					'max' => 3000,
					'depends' => array(array('video_source', '=', 'modal')),
				),
				...
				'video_width' => array(
					...
					'title' => JText::_('Width'),
					'max' => 3000,
					'desc' => JText::_('Set the video dimensions.'),
					'depends' => array(array('video_source', '!=', 'modal')),
				),
				'video_height' => array(
					'type' => 'slider',
				...
				'play_inline' => array(
					'type' => 'checkbox',
					'title' => JText::_('Play inline on mobile devices'),
					'values' => array(
						1 => JText::_('JYES'),
						0 => JText::_('JNO'),
					),
				...
				'autoplay' => array(
					...
					'desc' => JText::_('Disable autoplay, start autoplay immediately or as soon as the video enters the viewport.'),
					'values' => array(
						'' => JText::_('Off'),
						'true' => JText::_('On'),
						'inview' => JText::_('On (If inview)'),
					),
					'depends' => array(array('video_source', '!=', 'youtube-vimeo')),
					'std' => '',
				),

...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => JText::_('UI Simple Gallery'),
		...
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uisimplegallery/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'icon_transition' => array(
					'type' => 'select',
					'title' => JText::_('Icon Transition'),
					'desc' => JText::_('Select a hover transition for the icon.'),
					'values' => array(
						'' => JText::_('None'),
						'fade' => JText::_('Fade'),
						'scale-up' => JText::_('Scale Up'),

...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uitext',
		'title' => JText::_('UI Text'),
		'desc' => JText::_('A collection of useful utility classes to style your content.'),
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uitext/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'text_size' => array(
					'type' => 'select',
					'title' => JText::_('Text Size'),
					'desc' => JText::_('Select the text size.'),
					'values' => array(
						'' => JText::_('None'),
						'small' => JText::_('Small'),
						'large' => JText::_('Large'),
				...
				'columns' => array(
					...
					'desc' => JText::_('Display your content in multiple text columns without having to split it in several containers.'),
					'values' => array(
						'' => JText::_('None'),
						'1-2' => JText::_('Halves'),
						'1-3' => JText::_('Thirds'),
				...
				'divider' => array(
					...
					'desc' => JText::_('Show dividers between the text columns.'),
					'std' => 0,
				...
				'columns_breakpoint' => array(
					...
					'desc' => JText::_('Set the device width from which the text columns should apply. Note: For each breakpoint downward the number of columns will be reduced by one.'),
					'values' => array(
						'' => JText::_('Always'),

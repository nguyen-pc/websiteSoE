...
SpAddonsConfig::addonConfig(
	array(
		...
		'desc' => JText::_('A collection of animated headlines, with interchangeable words that replace one another through CSS transitions.'),
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uiheadline/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'headline_styles' => array(
					'type' => 'select',
					'title' => JText::_('Headline Styles'),
					'desc' => JText::_('Define different styles for headline.'),
					'values' => array(
				...
				'color' => array(
					'type' => 'color',
					'title' => JText::_('Intro Color'),
					'depends' => array(array('intro', '!=', '')),
				),
				'text_color' => array(
					'type' => 'color',
					'title' => JText::_('Highlighted Text color'),
				),

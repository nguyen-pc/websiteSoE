...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uitotop',
		'title' => JText::_('UI To Top'),
		'desc' => JText::_('Create a simple Smooth to-top scroller.'),
		'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uitotop/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				...
				'text_color' => array(
					...
					'desc' => JText::_('Add predefined text color to totop icon.'),
					'values' => array(
						'' => JText::_('None'),
						'muted' => JText::_('Muted'),

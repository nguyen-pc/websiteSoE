...
SpAddonsConfig::addonConfig(
	array(
		...
		'title'=>JText::_('UI Testimonial Pro'),
		'desc'=>JText::_('Testimonial Pro with UI Kit'),
        'icon'=>JURI::root() . 'plugins/sppagebuilder/jollyany/addons/uitestimonialpro/assets/images/icon.png',
		'category'=>'Jollyany',
		'attr'=>array(
			'general' => array(
